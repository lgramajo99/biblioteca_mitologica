...
function ElementListCategories({ data }) {
    ...
    return (
        <li className="flex w-full h-20 min-h-20 justify-between px-3 items-center border bg-lightComplement border-secondary dark:bg-darkPrimary rounded-lg shadow-sm shadow-secondary">
